...
<tbody>
<?php
$vendor=pg_query($db,"SELECT * FROM products LEFT JOIN vendors on vendors.id=products.vendorid LEFT JOIN cylindertype on cylindertype.id=products.cylindertypeid LEFT JOIN cylinderweight on cylinderweight.id=products.cylinderweightid WHERE products.status=1");
$i=1;
