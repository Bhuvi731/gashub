    ...
    <div class="row">
      ...
      <div class="col-4">
        <div class="card-footer clearfix" style="background-color:rgb(244 246 249) !important">
          <button type="button" class="btn btn-primary float-right" data-toggle="modal" data-target="#modal-default"><i class="fas fa-plus"></i> Add VendorAddress</button>
        </div>
      </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Add VendorAddress</h4>
          ...
          <div class="card-body ">
            ...
            <div class="container-fluid">
              <table id="example2" class="table table-bordered ">
                ...
                <tbody id="myTable">
                  <?php
                  $vendor = pg_query($db, "SELECT vendoraddresses.id,vendoraddresses.vendorid,vendors.businessname,vendoraddresses.createdby,vendoraddresses.addressline1,vendoraddresses.pincode,vendoraddresses.status from vendoraddresses LEFT JOIN vendors ON vendors.id=vendoraddresses.vendorid WHERE vendoraddresses.status=1");
                  $i = 1;
                    ...
                    <tr>
                      ...
                      <div class="modal fade" id="editmodal-default<?php echo $row['id']; ?>">
                        <div class="modal-dialog">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h4 class="modal-title">Edit VendorAddress</h4>
                              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                              </button>
                            </div>
                              ...
                              <form>
                                <div class="col-sm-6">
                                  <div class="form-group">
                                    ...
                                    <!-- <input type="text" class="form-control" id="addressline1<?php echo $row['id']; ?>" placeholder="Enter Address Line 1" name="addressline1" value="<?php echo $row['businessname']; ?>"> -->
...
<script>
  ...
  function success() {
    ...
    Toast.fire({
      icon: 'success',
      title: 'Vendor Address  Added Successfully.'
    })
    setTimeout(function() {
  ...
  function vendorname_existed() {
    ...
    Toast.fire({
      icon: 'info',
      title: 'vendorname already existed.'
    })
    setTimeout(function() {
      //alert('Reloading Page');
      location.reload(true);
  ...
  function editsuccess() {
    ...
    Toast.fire({
      icon: 'success',
      title: 'vendor  Address Edit Successfully.'
    })
    setTimeout(function() {
