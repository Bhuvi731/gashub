          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tbody id="myTable">
                  <?php
                  $vendor = pg_query($db, "SELECT cylinder.id,petroleum.petroleum_name,cylinder.petroleumid,cylinder.vendorid,vendors.businessname,cylinder.weight,cylinder.price,cylinder.status,cylinder.createdby FROM cylinder left join petroleum on petroleum.id=cylinder.petroleumid left join vendors on vendors.id=cylinder.vendorid  WHERE cylinder.status=1");
                  $i = 1;
