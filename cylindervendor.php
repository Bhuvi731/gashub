...
<body>
            ...
            <div class="row">
                ...
                <div class="col-4">
                    <div class="card-footer clearfix" style="background-color:rgb(244 246 249) !important">
                        <button type="button" class="btn btn-primary float-right" data-toggle="modal" data-target="#modal-default"><i class="fas fa-plus"></i> Add cylinder</button>
                    </div>
                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="availablestock" placeholder="Enter Available stock" name="availablestock">
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <tbody id="myTable">
                                    <?php
                                    $vendor = pg_query($db, "SELECT cylinder.id,petroleum.petroleum_name,cylinder.petroleumid,cylinder.vendorid,vendors.businessname,cylinder.weight,cylinderstock.price,cylinderstock.availablestock,cylinderstock.status,cylinder.createdby FROM cylinder left join petroleum on petroleum.id=cylinder.petroleumid left join vendors on vendors.id=cylinder.vendorid left join cylinderstock on cylinderstock.id=cylinder.id WHERE cylinderstock.status=1");
                                    $i = 1;
    ...
    <script type="text/javascript">
        function editsave(id) {
            ...
            var availablestock = $("#availablestock" + id).val();
