...
<input type="text" class="form-control" id="businessname" placeholder="Enter vendorname" name="businessname">
</div>
</div>
<div class="col-sm-6">
<div class="form-group">
...
$vendor=pg_query($db,"SELECT * from vendors WHERE vendors.status=1");
$i=1;
