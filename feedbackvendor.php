                ...
                <div class="card-body">
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tbody id="myTable">
                      ...
                      $vendor = pg_query($db, "SELECT feedbacks.id,feedbacks.vendorid,feedbacks.userid,feedbacks.rating,feedbacks.review,feedbacks.createdby,users.firstname,vendors.businessname,petroleum.petroleum_name,vendors.id,feedbacks.title,feedbacks.status FROM feedbacks LEFT JOIN useraddresses ON useraddresses.id=feedbacks.vendorid  LEFT JOIN vendors ON vendors.id=feedbacks.vendorid  LEFT JOIN petroleum ON petroleum.vendorid=feedbacks.id LEFT JOIN users ON users.id=feedbacks.userid  WHERE feedbacks.status=1 AND feedbacks.vendorid= $vendorid");
                      $i = 1;
                                ...
                                <div class="modal-body">
                                  <form>
                                    ...
                                    <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" id="name<?php echo $row['id']; ?>" placeholder="Enter User Name" name="name" value="<?php echo $row['name']; ?>">
                                    </div>
                                    <input type="hidden" id="loginid" name="loginid" value=<?php echo  $session_value; ?>>
                                    <!-- <div class="card-body"> -->
...
<script>
  ...
  function editsave(id) {
    ...
    if (username == "") {
      ...
      alert("Status must be filled out");
      return false;
    } else if (id !== "" && username !== "" && vendorname !== "" && brandname !== "" && status !== "" && rating !== "" && review !== "") {
      $.ajax({
        type: "GET",
