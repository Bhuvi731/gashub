          ...
          <div class="card-body">
            <table id="example2" class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                $vendor = pg_query($db, "SELECT ordermanagement.id,ordermanagement.userid,useraddresses.name,useraddresses.addressline1,vendors.businessname,ordermanagement.status,ordermanagement.createdby,ordermanagement.quantity,users.firstname,accessoriesstock.petroleumid ,petroleum.petroleum_name,accessoriesstock.price FROM ordermanagement LEFT JOIN users ON ordermanagement.userid=users.id LEFT JOIN useraddresses ON useraddresses.id=ordermanagement.deliveryaddressid LEFT JOIN vendors ON vendors.id=ordermanagement.vendorid  LEFT JOIN accessoriesstock on accessoriesstock.id=ordermanagement.accessoriesid LEFT JOIN petroleum on accessoriesstock.petroleumid=petroleum.id");
                // LEFT JOIN accessoriesstock on accessoriesstock.id=ordermanagement.accessoriesid
                $i = 1;
                while ($row = pg_fetch_array($vendor)) {
                ?>
