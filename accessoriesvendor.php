                                        ...
                                        <!-- <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="vendorbranch" name="vendorbranch">
                ...
                <div class="card">
                    ...
                    <div class="card-body ">
                        ...
                        <table id="example2" class="table table-bordered ">
                            ...
                            <tbody id="myTable">
                                <?php
                                $vendor1 = pg_query($db, "SELECT vendorid from login WHERE id=$session_value");
                                $getvendor = pg_fetch_assoc($vendor1);
                                $vendorid = $getvendor['vendorid'];
                                $vendor = pg_query($db, "SELECT accessories.id,accessories.accessoriesname,petroleum.petroleum_name,accessories.petroleumid,accessories.vendorid,accessories.vendoraddid,vendors.businessname,vendoraddresses.addressline1,accessories.price,accessories.status,accessories.createdby from  accessories left join petroleum on petroleum.id=accessories.petroleumid  left join vendors on vendors.id=accessories.vendorid left join vendoraddresses on vendoraddresses.id=accessories.vendoraddid WHERE  accessories.status=1");
                                $i = 1;
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form>
                                                            ...
                                                            <div class="form-group">
                                                                <label for="exampleSelectBorder">Vendor Branch</label>
                                                                <select class="custom-select" id="vendorbranch<?php echo $row['id']; ?>" name="vendorbranch">
                                                                    <!-- <option>Select Your petroleum Name</option> -->
                                                                    <?php
                                                                    $vendor1 = pg_query($db, "SELECT * FROM vendoraddresses WHERE status=1");
                                                                    while ($row1 = pg_fetch_assoc($vendor1)) {
                                                                    ?>
                                                                        <option value="<?php echo $row1['id']; ?>" <?php if ($row1['id'] == $row['vendoraddid']) echo "Selected"; ?>><?php echo $row1['addressline1']; ?></option>
                                                                    <?php
                                                                    }
                                                                    ?>
                                                                </select>
                                        ...
                                        <div class="container-fluid">
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="form-group">
                                                            <p class="text-sm"><?php echo $row['businessnaame']; ?>
                                                            </p>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-4">
...
<script>
    function save() {
        ...
        var vendoraddid = $("#vendorbranch").val();
        ...
        if (vendoraddid == "") {
            alert("Vendor Adddress must be filled out");
            return false;
        }
        if (price == "") {
        ...
        if (status == "") {
            ...
            return false;
        } else if (accessoriesname !== "" && petroleumid !== "" && vendorid !== "" && vendoraddid !== "" && price !== "" && status !== "") {
            $.ajax({
    ...
    function email_existed() {
        ...
        Toast.fire({
            icon: 'info',
            title: 'accessoriesname_already_existed'
        })
        setTimeout(function() {
    ...
    function editsave(id) {
        ...
        var vendoraddid = $("#vendorbranch" + id).val();
        ...
        if (vendoraddid == "") {
            alert("Vendor Address must be filled out");
            return false;
        }
        if (price == "") {
            alert("price must be filled out");
