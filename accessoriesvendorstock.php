...
<script>
    function save() {
        ...
        if (status == "") {
            ...
            return false;
        } else if (accessoriesname !== "" && vendorid !== "" && price !== "" && status !== "") {
            $.ajax({
                ...
                success: function(msg) {
                    ...
                    if (message == "success") {
                        success();
                    } else if (message == "product_already_existed") {
