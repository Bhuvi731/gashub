                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="firstname" placeholder="Enter First Name" name="firstname" onchange="validate()">
                          <div id="div1"></div> <br>
                        </div>
                      </div>
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="lastname" placeholder="Enter Last Name" name="lastname" onchange=" validate()">
                          <div id="div2"></div> <br>
                        </div>
                      </div>
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="number" class="form-control" id="phone" placeholder="Enter Phone Number" name="phone" pattern="[1-9]{1}[0-9]{9}" maxlength="10" onchange="validate()">
                          <div id="div3"></div> <br>
                        </div>
                      </div>
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="email" placeholder="Enter Email" name="email" onchange="validate()">
                          <div id="div4"></div> <br>
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="password" placeholder="Enter Password" name="password" onchange="validate()">
                          <div id="div5"></div> <br>
                        </div>
                      </div>
                      <div class="col-sm-6">
...
<script>
  function validate() {
    ...
    if (!/^[A-Za-z\s]+$/.test(firstname)) {
      document.getElementById("div1").innerHTML = "Enter the valid firstname";
    ...
    if (!/^[A-Za-z\s]+$/.test(lastname)) {
      document.getElementById("div2").innerHTML = "Enter the valid lastname";
    ...
    if (phone.length > 10 || phone.length < 10) {
      document.getElementById("div3").innerHTML = "Enter the valid phone number";
    ...
    if (password == "") {
      document.getElementById("div5").innerHTML = " Enter the password";
      document.getElementById("div5").style.color = "Red";
    } else if (password.length < 8 || password.length > 15 && (!/^[A-Za-z]\w{7,14}$/.test(password))) {
      document.getElementById("div5").innerHTML = "Password is weak";
      document.getElementById("div5").style.color = "Red";
    } else {
